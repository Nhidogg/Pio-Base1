...
class aedon1 extends StatefulWidget{
  @override
  _aedon1 createState()=> new _aedon1();


}
@override

class _aedon1 extends State<aedon1> with SingleTickerProviderStateMixin{
              ...
              Row(
                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () async{
                      Navigator.pop(context);
                      final ByteData bytes = await rootBundle.load('assets/img/ratonas.jpg');
                      await Share.file('Chochín criollo ', 'ratonas.jpg', bytes.buffer.asUint8List(), "image/jpg", text: '');
            ...
            child:  Column(
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Chochín criollo ", style: TextStyle(
                      color: Colors.white,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Ratona (Nativa)", style: TextStyle(
                      color: Colors.white,
                      fontSize: MediaQuery.of(context).size.height*0.03,
                      fontFamily: 'Metrolight',
                      fontStyle: FontStyle.normal ,
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: PinchZoomImage(
                              ...
                              image: Image.asset('assets/img/ratonas.jpg',fit: BoxFit.scaleDown, scale: MediaQuery.of(context).size.width *0.0109,),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(text: 'Troglodytes aedon', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.italic )),
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text("Se mueve rápidamente entre arbustos y árboles, buscando pequeños insectos para comer.",style: TextStyle(
                                        color: Colors.white,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text(
                                        ...
                                        "De pequeño tamaño, rechoncho y cola estrecha. Plumaje de color pardo, con listado negro en las alas y las cola. La parte ventral de color marrón más claro.",style: TextStyle(
                                        color: Colors.white,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        fontFamily: 'Metromedium',
                                        fontStyle: FontStyle.normal,
