                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () async{
                      ...
                      await Share.file('Colibrí gigante', 'gigas.png', bytes.buffer.asUint8List(), "image/png", text: '');
            ...
            child:  Column(
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Colibrí gigante", style: TextStyle(
                      color: Colors.white,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text("Alimentándose en plantas con flores tubulares.",style: TextStyle(
                                        color: Colors.white,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text(
                                        ...
                                        "Picaflor, ave muy pequeña, de plumaje oscuro con tonos marrones. Pico largo y delgado, su vuelo es más entorpecido y lento en comparación a otros colibríes.",style: TextStyle(
                                        color: Colors.white,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        fontFamily: 'Metromedium',
                                        fontStyle: FontStyle.normal,
