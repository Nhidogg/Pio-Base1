...
class punensis extends StatefulWidget{
  @override
  _punensis createState()=> new _punensis();


}
@override

class _punensis extends State<punensis> with SingleTickerProviderStateMixin{
              ...
              Row(
                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () async{
                      Navigator.pop(context);
                      final ByteData bytes = await rootBundle.load('assets/img/punensis.png');
                      await Share.file('Yal peruano', 'punensis.png', bytes.buffer.asUint8List(), "image/png", text: '');
            ...
            child:  Column(
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Yal peruano", style: TextStyle(
                      color: Colors.white,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Chubta (Nativa)", style: TextStyle(
                      color: Colors.white,
                      fontSize: MediaQuery.of(context).size.height*0.03,
                      fontFamily: 'Metrolight',
                      fontStyle: FontStyle.normal ,
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: PinchZoomImage(
                            ...
                            image: Image.asset('assets/img/punensis.png',fit: BoxFit.scaleDown, scale: MediaQuery.of(context).size.width *0.0109,),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(text: 'Phrygilus punensis', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.italic )),
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text("En el suelo buscando semillas, también perchando en arbustos y árboles",style: TextStyle(
                                        color: Colors.white,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text(
                                        ...
                                        "Pájaro mediano con cabeza, cuello, alas y cola de color gris celeste oscuro que contrastan con su dorso y vientre amarillos, pico córneo",style: TextStyle(
                                        color: Colors.white,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        fontFamily: 'Metromedium',
                                        fontStyle: FontStyle.normal,
