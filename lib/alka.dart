...
class alka extends StatefulWidget{
  @override
  _alka createState()=> new _alka();


}
@override

class _alka extends State<alka> with SingleTickerProviderStateMixin{
              ...
              Row(
                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () async{
                      Navigator.pop(context);
                      final ByteData bytes = await rootBundle.load('assets/img/alkamari.png');
                      await Share.file('Caracara andino', 'alkamari.png', bytes.buffer.asUint8List(), "image/png", text: '');
            ...
            child:  Column(
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Caracara andino", style: TextStyle(
                      color: Colors.white,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Alkamari (Nativa)", style: TextStyle(
                      color: Colors.white,
                      fontSize: MediaQuery.of(context).size.height*0.03,
                      fontFamily: 'Metrolight',
                      fontStyle: FontStyle.normal ,
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: PinchZoomImage(
                            ...
                            image: Image.asset('assets/img/alkamari.png',fit: BoxFit.scaleDown, scale: MediaQuery.of(context).size.width *0.0109,),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(text: 'Phalcoboenus megalopterus', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.italic )),
                                        ...
                                        TextSpan(text: 'Rapaces diurnas (Falconiformes)', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.normal )),
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text("Habitualmente se la puede ver sobrevolando, buscando alimento y en el suelo.",style: TextStyle(
                                        color: Colors.white,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text(
                                        ...
                                        "Ave de gran tamaño, color negro con vientre blanco, un pico claro y con la base roja-anaranjada (mientras los juveniles son marrones).",style: TextStyle(
                                        color: Colors.white,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        fontFamily: 'Metromedium',
                                        fontStyle: FontStyle.normal,
