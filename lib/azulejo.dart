...
class azulejo extends StatefulWidget{
  @override
  _azulejo createState()=> new _azulejo();


}
@override

class _azulejo extends State<azulejo> with SingleTickerProviderStateMixin{
              ...
              Row(
                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () async{
                      Navigator.pop(context);
                      final ByteData bytes = await rootBundle.load('assets/img/sayaca.jpg');
                      await Share.file('Azulejo', 'sayaca.jpg', bytes.buffer.asUint8List(), "image/jpg", text: '');
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: PinchZoomImage(
                            ...
                            image: Image.asset('assets/img/sayaca.jpg',fit: BoxFit.scaleDown, scale: MediaQuery.of(context).size.width *0.0109,),
                                  ...
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(text: 'Thraupis sayaca', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.italic )),
                                   ...
                                   Column(
                                    children: <Widget>[
                                      Text("Se encuentra en áreas periurbanas, agrícolas, parques urbanos y jardines.",style: TextStyle(
                                        color: Colors.white,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text(
                                        ...
                                        "Ave pequeña, tiene un cuerpo gris azulado con las alas de un tono azul más oscuro.",style: TextStyle(
                                        color: Colors.white,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        fontFamily: 'Metromedium',
                                        fontStyle: FontStyle.normal,
