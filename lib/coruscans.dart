...
class coruscans extends StatefulWidget{
  @override
  _coruscans createState()=> new _coruscans();


}
@override

class _coruscans extends State<coruscans> with SingleTickerProviderStateMixin{
              ...
              Row(
                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () async{
                      Navigator.pop(context);
                      final ByteData bytes = await rootBundle.load('assets/img/coruscans.png');
                      await Share.file('Colibrí Rutilante', 'coruscans.png', bytes.buffer.asUint8List(), "image/png", text: '');
            ...
            child:  Column(
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Colibrí rutilante", style: TextStyle(
                      color: Colors.white,
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: PinchZoomImage(
                            ...
                            image: Image.asset('assets/img/coruscans.png',fit: BoxFit.scaleDown, scale: MediaQuery.of(context).size.width *0.0109,),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(text: 'Colibri coruscans', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.italic )),
                                        ...
                                        TextSpan(text: 'Baja - media', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.normal )),
                                        ...
                                        TextSpan(text: 'Picaflores y vencejos (Apodiformes)', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.normal )),
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text("Alimentándose de néctar en plantas con flores tubulares o defendiendo su territorio perchando en árboles.",style: TextStyle(
                                        color: Colors.white,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text(
                                        ...
                                        "Picaflor, ave muy pequeña de plumaje verde con tonos azules y violetas tornasoles, de pico muy largo y fino.",style: TextStyle(
                                        color: Colors.white,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        fontFamily: 'Metromedium',
                                        fontStyle: FontStyle.normal,
