...
class spoagra extends StatefulWidget{
  @override
  _spoagra createState()=> new _spoagra();


}
@override

class _spoagra extends State<spoagra> with SingleTickerProviderStateMixin{
              ...
              Row(
                ...
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () async{
                      Navigator.pop(context);
                      final ByteData bytes = await rootBundle.load('assets/img/atrata.jpg');
                      await Share.file('Jilguero negro', 'atrata.jpg', bytes.buffer.asUint8List(), "image/jpg", text: '');
            ...
            child:  Column(
              children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Jilguero negro", style: TextStyle(
                      color: Colors.white,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Chaiñita (Nativa)", style: TextStyle(
                      color: Colors.white,
                      fontSize: MediaQuery.of(context).size.height*0.03,
                      fontFamily: 'Metrolight',
                      fontStyle: FontStyle.normal ,
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: PinchZoomImage(
                            ...
                            image: Image.asset('assets/img/atrata.jpg',fit: BoxFit.scaleDown, scale: MediaQuery.of(context).size.width *0.0109,),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  RichText(
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(text: 'Spinus atrata', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.italic )),
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text("Normalmente andan en grupos y vocalizando, en arbustos o en el suelo buscando alimento.",style: TextStyle(
                                        color: Colors.white,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Text(
                                        ...
                                        "Pequeño pájaro con plumaje negro en la parte baja del vientre y una franja en el ala de color amarillo intenso.",style: TextStyle(
                                        color: Colors.white,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        fontFamily: 'Metromedium',
                                        fontStyle: FontStyle.normal,
