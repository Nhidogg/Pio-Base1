...
class Torcaza extends StatefulWidget{
  @override
  _Torcaza createState()=> new _Torcaza();


}
@override

class _Torcaza extends State<Torcaza> with SingleTickerProviderStateMixin{
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    IconButton(
                                      ...
                                      onPressed: () async{
                                        Navigator.pop(context);
                                        final ByteData bytes = await rootBundle.load('assets/img/zenaida.png');
                                        await Share.file('Zenaida torcaza', 'zenaida.png', bytes.buffer.asUint8List(), "image/png", text: '');
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: PinchZoomImage(
                                            ...
                                            image: Image.asset('assets/img/zenaida.png',fit: BoxFit.scaleDown, scale: MediaQuery.of(context).size.width *0.0109,),
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                RichText(
                                                  text: TextSpan(
                                                    ...
                                                    children: <TextSpan>[
                                                      ...
                                                      TextSpan(text: 'Zenaida auriculata', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.italic )),
                                                      ...
                                                      TextSpan(text: 'Palomas (Columbiformes)', style: TextStyle(color: Colors.white, fontFamily: 'Metromedium',fontSize:MediaQuery.of(context).size.width*0.045,fontStyle:FontStyle.normal )),
                                                ...
                                                Column(
                                                  children: <Widget>[
                                                    Text("En el suelo, buscando semillas, muchas veces con un grupo de otras aves granívoras.",style: TextStyle(
                                                      color: Colors.white,
                                                ...
                                                Column(
                                                  children: <Widget>[
                                                    Text(
                                                      ...
                                                      "Mide 28 cm de largo. Los machos presentan coloración celeste en la parte superior de la cabeza y ligera coloración rosada o dorada en el pecho. Las hembras presentan color oscuro, es decir no tienen tonalidades diferentes a su plumaje normal.",style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize: MediaQuery.of(context).size.width*0.045,
                                                      fontFamily: 'Metromedium',
                                                      fontStyle: FontStyle.normal,
